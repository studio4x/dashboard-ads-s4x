  ...
  getMetaAdsAvailableMetrics(headers: string[]) {
    ...
    return {
      ...
      fields: {
        ...
        cpc: has("CPC (All)"),
        ctr: has("CTR (All)"),
        messagingConversationsStarted: has("Messaging Conversations Started"),
        costPerMessagingConversationsStarted: has("Cost per Messaging Conversations Started"),
        ...
        conversionAny: has("Messaging Conversations Started") || has("Leads") || has("On-Facebook Leads") || has("Website Leads") || has("Offline Leads"),
        conversionCostAny: has("Cost per Messaging Conversations Started") || has("Cost per Lead") || has("Cost per On-Facebook Lead") || has("Cost per Website Lead") || has("Cost per Offline Lead"),
