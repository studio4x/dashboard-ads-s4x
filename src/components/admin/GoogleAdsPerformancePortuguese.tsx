...
const ENUM_TRANSLATIONS: Array<[string, string]> = [
  ...
  ["NEAR_PHRASE", "Variação próxima de correspondência de frase"],
  ["NEAR_EXACT", "Variação próxima de correspondência exata"],
...
const TEXT_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/Revisar keywords com gasto sem conversão/gi, "Revisar palavras-chave com gasto sem conversão"],
  [/Melhorar relevância keyword → anúncio → landing page/gi, "Melhorar relevância entre palavra-chave, anúncio e página de destino"],
  ...
  [/\bGoogle Ads API\b/gi, "integração do Google Ads"],
  [/\bCRM\/planilha\b/gi, "sistema de contatos/planilha"],
  [/\bCRM\b/g, "sistema de contatos"],
