...
export async function ClientPageContent({ clientId, activeTab }: { clientId: string; activeTab: ClientPageTab }) {
  await requireAdmin();
  ...
  return (
    <div className="admin-page" style={{ padding: "clamp(14px, 3vw, 32px)", maxWidth: 1200 }}>
      ...
      <ClientPageTabs clientId={client.id} activeTab={activeTab} />
      ...
      {activeTab === "visao-geral" ? (
        ...
        <ClientAutomationHistoryPanel clientId={client.id} />
      )}
    </div>
  );
}
